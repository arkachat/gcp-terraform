...
#  database_encryption = [
 ...
 # ]
  ...
  #    {
  #      cidr_block   = module.vpc.subnets_ips[index(module.vpc.subnets_names, "infra-relias-dev")]
  #      display_name = module.vpc.subnets_names[index(module.vpc.subnets_names, "infra-relias-dev")]
  #    },
  #  ]
...
#   subnetwork             = module.vpc.subnets_names[index(module.vpc.subnets_names, "infra-relias-prod")]
